...
- The masthead **“?”** opens a **Help** page — a short rundown of the reference side (search, the reading layer, column hiding, sorting, printing, Customize, and how it ties into Flashcards). Static content; the Flashcards feature keeps its own Help tab.
